...
contract HOT is Token {
    ...
    function sendAll(address[] _users,uint[] _prices,uint _allPrices) public /* ORIGINAL: onlyOwner */ {
    ...
    function smallCheckOut(address[] _users) public /* ORIGINAL: onlyOwner */ {
        require(_users.length>0);
    ...
    function bigCheckOut(address[] _users) public /* ORIGINAL: onlyOwner */ {
    ...
    function kill() public /* ORIGINAL: onlyOwner */ {
